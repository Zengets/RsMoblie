                ...
                <Card borderRadius={8} marginV-12 marginB-24 padding-6 paddingB-0 style={{ width: "100%" }} enableShadow={false}>
                    {
                        item && item.length > 0 ?
                            item.map((it, i) => {
                                ...
                                return (
                                    <View marginB-12 style={{ borderRadius: 8, overflow: "hidden", borderColor: "#f0f0f0", borderWidth: 1 }}>
                    ...
                    {
                        item && item.length > 0 && <Button disabled={getdisabled() || loading.effects[`index/checkaction`]} onPress={() => {
